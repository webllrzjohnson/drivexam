...
-- CreateEnum
CREATE TYPE "LicenseStage" AS ENUM ('G1', 'G2', 'G');

-- CreateEnum
CREATE TYPE "UploadAssetType" AS ENUM ('LOGO', 'FAVICON', 'ROAD_SIGN', 'BLOG_IMAGE', 'CONTENT_IMAGE', 'OTHER');
...
CREATE TABLE "UploadAsset" (
    "id" TEXT NOT NULL,
    "type" "UploadAssetType" NOT NULL DEFAULT 'OTHER',
...
-- CreateIndex
CREATE INDEX "UploadAsset_type_idx" ON "UploadAsset"("type");
