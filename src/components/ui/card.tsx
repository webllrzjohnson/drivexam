...
type CardTitleProps = React.HTMLAttributes<HTMLElement> & { as?: React.ElementType };
export function CardTitle({ as: Comp = "h3", className, ...props }: CardTitleProps) { return <Comp className={cn("text-2xl font-semibold leading-none tracking-tight", className)} {...props} />; }
